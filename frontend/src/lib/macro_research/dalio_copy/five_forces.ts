  ...
  loops: {
    ...
    network: {
      ...
      edges: [
        ...
        { fromLabel: "Internal politics", toLabel: "Geopolitical", strength: 0.4 },
        { fromLabel: "Debt / money", toLabel: "Geopolitical", strength: 0.36 },
        { fromLabel: "Geopolitical", toLabel: "Internal politics", strength: 0.36 },
        { fromLabel: "Internal politics", toLabel: "Debt / money", strength: 0.32 },
        { fromLabel: "Technology", toLabel: "Internal politics", strength: 0.28 },
        { fromLabel: "Nature", toLabel: "Debt / money", strength: 0.28 },
        { fromLabel: "Nature", toLabel: "Internal politics", strength: 0.21 },
        { fromLabel: "Technology", toLabel: "Debt / money", strength: 0.14 },
        { fromLabel: "Nature", toLabel: "Geopolitical", strength: 0.14 },
      ],
      projections: [
        { force: "Debt / money", current: 9, projected: 8.7, delta: -0.3 },
        { force: "Internal politics", current: 8, projected: 8.1, delta: 0.1 },
        { force: "Geopolitical", current: 9, projected: 8.8, delta: -0.2 },
        { force: "Technology", current: 7, projected: 7, delta: 0 },
        { force: "Nature", current: 7, projected: 7, delta: 0 },
      ],
