...
> **Not investment advice.** OpenLIA produces AI-generated research for
> informational and educational purposes only. See the
> [Disclaimer](#disclaimer) before acting on any output.
...
OpenLIA is a research tool, not a financial adviser.

- Its reports, dashboards, scores, and chat responses are **generated by
  large language models** and automated data pipelines. They may be
  **inaccurate, incomplete, out of date, or entirely wrong**.
- All output is provided for **informational and educational purposes
  only**. It is **not** investment, financial, legal, tax, or accounting
  advice, and it is not a recommendation, offer, or solicitation to buy
  or sell any security or financial instrument.
- **You are solely responsible for your own decisions.** Do your own
  research and consult a qualified, licensed professional before acting
  on anything OpenLIA produces.
- OpenLIA connects to third-party data and LLM providers that you
  configure. **You are responsible for complying with the licenses,
  terms of service, and usage limits of every provider you connect**, and
  for the accuracy of the data they return.
- The software is provided "as is", without warranty of any kind. The
  authors and contributors accept no liability for any loss or damage
  arising from its use. See [LICENSE](LICENSE) for the full terms.
