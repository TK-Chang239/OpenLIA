...
Hosts the LLM providers admin sub-router. The legacy data-providers admin
sub-router was removed during the connector cutover; that surface now lives
under /api/connectors via routes/connectors.py.
"""
