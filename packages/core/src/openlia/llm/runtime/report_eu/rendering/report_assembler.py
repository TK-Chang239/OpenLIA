...
.report-disclaimer {
  margin-top: 2.5rem; padding-top: 1rem; border-top: 1px solid #d0d0d0;
  font-size: .72rem; line-height: 1.5; color: #666;
  break-inside: avoid;
}
/* Keep the one-line disclaimer flowing after the sources in print — a
   large leading gap plus the body's bottom padding routinely pushed it
   onto an otherwise-blank final PDF page. */
@media print {
  body { padding-bottom: 0; }
  .v3-bibliography { margin-top: 1.5rem; }
  .report-disclaimer { margin-top: 1rem; padding-top: .5rem; }
}
